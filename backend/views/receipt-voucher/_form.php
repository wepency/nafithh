    ...
    <div class="box-body table-responsive">
        <fieldset>
            <div class='col-sm-12'>
                ...
                <div class='col-sm-4'>
                    <?= $form->field($model, 'recipient_type')->widget(Select2::class, [
                        'data' => array_merge(
                            ReceiptVoucher::getListRecipient()
                        ),
                        'options' => [
                            'prompt' => Yii::t('app', 'Recipient Type'),
                            'onchange' => '
            ...
            recipient_name = $(".field-recipient_name"); // Assuming this is the class for Recipient Name
            ...
            switch(value) {
                case "owner":
                    ...
                    hideEv(building);
                    showEv(owner);
                    hideEv(recipient_name); // Hide the other field
                    break;
                ...
                case "other":
                    ...
                    showEv(building);
                    hideEv(owner);
                    showEv(recipient_name); // Show the other field
                    break;
                default:
                    hideEv(mainOff);
                    showEv(hous);
            ...
            function hideEv(elem) {
                elem.parent().prev().hide();
                elem.parent().hide();
            }

            function showEv(elem) {
        ...
        '
                ...
                <label for='' class='col-sm-2 control-label d-none'><?= Yii::t('app', 'Recipient Name') ?></label>
                <div class='col-sm-4 d-none'>
                    <div class='form-group field-recipient_name'>
                        <?= $form->field($model, 'recipient_name')->textInput()->label(false) ?>
                    </div>
                </div>
