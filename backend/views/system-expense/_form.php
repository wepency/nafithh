...
<div class="system-expense-form box box-primary">
     ...
     <div class="box-body table-responsive">
		<fieldset>
            <div class='col-sm-12'>
                ...
                <label for='' class='col-sm-2 control-label'><?=Yii::t('app', 'Expense Item')?></label>
                <div class='col-sm-4'>
                ...
                <label for='' class='col-sm-2 control-label'><?=Yii::t('app', 'Expense Date')?></label>
                <div class='col-sm-4'>
