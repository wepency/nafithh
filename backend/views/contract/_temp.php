            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="block-title clearfix">
                        <h5><?=Yii::t('app', 'Created Date ')?> :  <span><?= Yii::$app->formatter->asDate($model->created_date, 'php:Y/m/d');?></span> </h5>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="block-title clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" class="custom-control-input" disabled id="customCheck1" <?=($housing->kitchen)? 'checked' :'' ?> >
                                    <label class="custom-control-label" for="customCheck1" ><?=Yii::t('app', 'There is').' '.Yii::t('app', 'Kitchen')?></label>
                                </div>

                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" class="custom-control-input" disabled id="customCheck2" <?=($housing->pool)? 'checked':'' ?>>
                                    <label class="custom-control-label" for="customCheck2"   ><?=Yii::t('app', 'There is').' '.Yii::t('app', 'Pool')?></label>
                                </div>

                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" class="custom-control-input" disabled id="customCheck3" <?=($housing->has_parking)? 'checked':'' ?>>
                                    <label class="custom-control-label" for="customCheck3"   ><?=Yii::t('app', 'Has Parking')?></label>
                                </div>
