    ...
    <div class="box-body table-responsive">
        <fieldset>
			<div class='col-sm-12'>
				...
				<label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Number Messages') ?> </label> 

				<div class='col-sm-4'><?= $form->field($model, 'amount')->textInput()->label(false) ?></div>

				<label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Price') ?> </label> 

				<div class='col-sm-4'><?= $form->field($model, 'price')->textInput()->label(false) ?></div>
