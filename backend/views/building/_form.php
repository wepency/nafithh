...
<div class="building-form box box-primary">
    ...
    <div class="box-body table-responsive">
       <fieldset>
            ...
            <div class='col-sm-12'>	
                ...
                <label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Authorization Number') ?> <span class="clsReq">*</span></label></label>
		    ...
		    <div class='col-sm-12'>	
				<label for='' class='col-sm-2 control-label'><?=Yii::t('app', 'Title Ads')?> <span class="clsReq">*</span></label>
				<div class='col-sm-10'>
	                <?= $form->field($model, 'ad_description')->textInput(['placeholder'=>Yii::t('app', 'Example: A villa for sale in Al-Rabee neighborhood')])->label(false) ?>
				</div>
            ...
            <div class='col-sm-12'>	
                ...
                <label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Status Ad') ?> <span class="clsReq">*</span></label> 
				<div class='col-sm-4'>
       ...
       <fieldset>
			...
			<div class='col-sm-12'>
				...
				<div class="clearfix"></div>
				 ...
				 <label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Building Age') ?> <span class="clsReq">*</span></label> 
		...
		<fieldset>
			...
			<div class='col-sm-12'>
                ...
                <label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Length') ?> <span class="clsReq">*</span></label>
				<div class='col-sm-4'><?= $form->field($model, 'length')->textInput(['maxlength' => true])->label(false) ?></div>

                <label for='' class='col-sm-2 control-label'><?= Yii::t('app', 'Width') ?> <span class="clsReq">*</span></label>
	...
	<fieldset>
			...
			<div class='col-sm-12'>	
			   	<label for='' style="width:120px;" class='col-sm-1 control-label'><?= Yii::t('app', 'Rent Price') ?> </label> 
               	<div class='col-sm-2'><?= $form->field($model, 'rent_price')->textInput()->label(false) ?></div>	
              	<label for='' style="width:120px;" class='col-sm-1 control-label'><?= Yii::t('app', 'Sale Price') ?> </label> 
               	<div class='col-sm-2'><?= $form->field($model, 'sale_price')->textInput()->label(false) ?></div>	
               	<label for='' style="width:120px;" class='col-sm-1 control-label'><?= Yii::t('app', 'Invest Price') ?> </label> 
               	<div class='col-sm-2'><?= $form->field($model, 'invest_price')->textInput()->label(false) ?></div>	
				<div class="clearfix"></div>		
            </div>
		</fieldset>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:430px; overflow-y:auto;">
         ...
         <p dir="rtl" style=""><span style="">هذه الصفحة مخصصة أولا: لإيضاح الضوابط للإعلانات العقارية المقدمة من الهيئة العامة للعقار وضرورة التقيد بها</span></p>

<p dir="rtl" style=""><span style="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;وثانيا: لسرد الشروط والأحكام لاستخدام المنصة سواء للمسجلين وغير المسجلين وفهمها</span></p>

<p dir="rtl" style=""><span style="">يجب على المعلنين في منصة نافذة التقيد بما سنورده من شروط وضعتها الهيئة العامة للعقار كما نبين أن أي إخلال أو مخالفة لهذه الشروط والضوابط قد يترتب عليه حذف الإعلان وقد يصل إلى إيقاف الحساب&nbsp;</span></p>
...
<p dir="rtl" style=""><span style="">2)الإعلان العقاري: الإعلان المرئي أو المقروءة أو المسموع؛ لغرض التصرف في العقار بأي وسيلة كانت.</span></p>

<p dir="rtl" style=""><span style="">3)المعلن: طالب نشر الإعلان العقاري سواء أكان الإعلان لنفسه أم لغيره بأي وسيلة كانت.</span></p>

<p dir="rtl" style=""><span style="">4)المنصة العقارية الالكترونية: التطبيق أو الموقع الإلكتروني ونحوهم المختصة بالتسويق للإعلان العقاري.</span></p>

<p>&nbsp;</p>

<p dir="rtl" style=""><span style="">ثانيا:</span></p>

<p dir="rtl" style=""><span style="">دون إخلال باختصاصات الجهات ذات العلاقة، واختصاص الهيئة العامة للإعلام المرئي والمسموع يجب الالتزام في الإعلان العقاري بما يلي:</span></p>
...
<p dir="rtl" style=""><span style="">3) الالتزام بما يصدر به الدليل العام لضوابط المحتوى الإعلاني.</span></p>

<p dir="rtl" style=""><span style="">4) الالتزام بما يصدر من الجهات المختصة بتنظيم المحتوى الأخلاقي والإعلامي بجميع وسائطه المعلوماتية (التقليدية والإلكترونية)</span></p>

<p dir="rtl" style=""><span style="">5) الالتزام بالأسماء الرسمية، من مدن وأحياء وشوارع وأنواع للعقارات، ويجوز إضافة الأسماء المتعارف عليها إضافة لها.</span></p>
...
<p dir="rtl" style=""><span style="">هـ. رقم ترخيص المعلن إن كان مكتبا أو مسوقا عقاريا أو حاصلا على وثيقة عمل حر.</span></p>

<p dir="rtl" style=""><span style="">و. موقع العقار على أن يحتوي _بحد أدنى_ (المدينة – الحي – رقم المخطط إن وجد).</span></p>
...
<p dir="rtl" style=""><span style="">- الرهن أو القيد الذي يمنع أو يحد من التصرف أو الانتفاع من العقار.</span></p>

<p dir="rtl" style=""><span style="">- الحقوق والالتزامات على العقار غير الموثقة في وثيقة العقار.</span></p>

<p dir="rtl" style=""><span style="">-الخدمات المتعلقة بالعقار.</span></p>

<p dir="rtl" style=""><span style="">- المعلومات التي قد تؤثر في العقار سواء في خفض قيمته أو التأثير على قرار المستهدف بالإعلان، مثل الضمانات ومددها ومطابقة كود البناء السعودي والعمر للعقار القائم وغير ذلك.</span></p>

<p dir="rtl" style=""><span style="">- إن كان الإعلان عن مزاد عقاري يجب _ إضافة إلى مايصدر من الجهات ذات العلاقة _أن يتضمن رقم ترخيص المزاد، ومكانه، وشروطه، والموعد المحدد لإقامته، ومدته الزمنية، والموعد النهائي للتقدم للمزاد -إن وجد-.</span></p>

<p dir="rtl" style=""><span style="">ثالثا:</span></p>

<p dir="rtl" style=""><span style="">أن يحتوي الإعلان العقاري في المنصة العقارية الالكترونية إضافة إلى البيانات الواردة في البند (ثانيا) على البيانات الآتية:</span></p>

<p dir="rtl" style=""><span style="">1) وصف العقار بما يشمل نوعه وعمره ومحتوياته وأي وصف مؤثر مثل: عرض الشارع الواقع عليه، وواجهة العقار وغيرها.</span></p>
...
<p dir="rtl" style=""><span style="">دون إخلال باختصاصات الجهات ذات العلاقة يحظر تضمين الإعلان العقاري أيا مما يأتي:</span></p>

<p dir="rtl" style=""><span style="">1) مخالفة للتعليمات الإسلامية أو للأنظمة والتعليمات في المملكة أو للأعراف السائدة.</span></p>

<p dir="rtl" style=""><span style="">2) خدشا للحياء.</span></p>

<p dir="rtl" style=""><span style="">3) انتهاكا لحقوق الملكية الفكرية.</span></p>

<p dir="rtl" style=""><span style="">4) التعرض بصورة سلبية للمنافسين أو منشآت القطاع الخاص أو غيرها.</span></p>

<p dir="rtl" style=""><span style="">5) عبارات أو إشارات يفهم منها التمييز ضد أحد أيا كان.</span></p>

<p dir="rtl" style=""><span style="">6) صورا، أو بيانات، أو موقعا، أو مناظير مضللة أو لا تخص العقار المعلن عنه.</span></p>

<p dir="rtl" style=""><span style="">7) شعار الهيئة أو اسمها أو أي من الجهات الحكومية الأخرى إلا بإذن مسبق منها.</span></p>

<p dir="rtl" style=""><span style="">خامسا:</span></p>

<p dir="rtl" style=""><span style="">يحظر نشر الإعلانات العقارية الوهمية؛ لغرض جمع بيانات المتلقين أو العموم أو أي غرض آخر.</span></p>

<p dir="rtl" style=""><span style="">سادسا:</span></p>

<p dir="rtl" style=""><span style="">يجب إزالة الإعلان العقاري خلال مدة لا تزيد على يومين من تاريخ تمام أو انتهاء الغرض منه.</span></p>

<p dir="rtl" style=""><span style="">سابعا:</span></p>

<p dir="rtl" style=""><span style="">تقوم الهيئة بالرقابة على الالتزام بأحكام هذه الضوابط، وإحالة المخالفة للجهات المختصة لاتخاذ الإجراءات النظامية بشأنها.</span></p>
...
<p dir="rtl" style=""><span style="font-size:13.999999999999998pt;color:#000000;background-color:transparent;font-weight:700;font-style:normal;font-variant:normal;text-decoration:none;vertical-align:baseline;white-space:pre;white-space:pre-wrap;">الشروط والأحكام لمنصة نافذة</span></p>
...
<p dir="rtl" style=""><span style="">المنصة: موقع إلكتروني على شبكة الإنترنت تقدم نافذة من خلاله خدمات إلكترونية.</span></p>

<p dir="rtl" style=""><span style="">المستخدم: أي شخص يستفيد من الخدمات الإلكترونية التي تقدمها نافذة من خلال المنصة سواء كان أصيل أو ممثل مسجلاً أو غير مسجل</span></p>



<p dir="rtl" style=""><span style="">مقدمة</span></p>

<p dir="rtl" style=""><span style="">تقدم منصة نافذة خدماتها الإلكترونية عبر المنصة الإلكترونية وهي متاحة للاستخدام من قبل الجميع.</span></p>

<p dir="rtl" style=""><span style="">يخضع دخول المستخدم واستخدامه لهذه المنصة للشروط والأحكام المذكورة في هذه الوثيقة.</span></p>
...
<p dir="rtl" style=""><span style="">يعد دخول المستخدم للمنصة واستخدامها موافقة على هذه الشروط والأحكام دون قيد أو شرط.</span></p>

<p dir="rtl" style=""><span style="">التسجيل في المنصة</span></p>

<p dir="rtl" style=""><span style="">يقتضي استخدام الخدمات الإلكترونية التسجيل في المنصة، علماً بأنه ليست هناك رسوم لعملية التسجيل في المنصة حالياً، وفي القريب ستوفر المنصة عدة باقات تتناسب مع عملائها.</span></p>



<p dir="rtl" style=""><span style="">التزامات المستخدم</span></p>

<p dir="rtl" style=""><span style="">يقر المستخدم بأن أي معلومات يقدمها عبر المنصة هي معلومات كاملة ودقيقة ومحدثة. كما يتحمل المسؤولية عن محتوى أي معلومة أو وثيقة يتم تقديمها من خلال المنصة.</span></p>

<p dir="rtl" style=""><span style="">يتحمل المستخدم المسئولية الكاملة في حالة انتحاله اسم مستخدم آخر ويحق لشركة نافذة الرقمية إيقاف الاشتراك في حال اكتشاف الانتحال مع اتخاذ الاجراءات النظامية حيال ذلك.</span></p>

<p dir="rtl" style=""><span style="">يقر المستخدم بأنه لن يقوم بتمثيل أي شخص طبيعي أو معنوي من دون أن يكون مخولاً بذلك.</span></p>

<p dir="rtl" style=""><span style="">يقر المستخدم بأن دخول المنصة واستخدامه لها سيكون لأغراض مشروعة فقط، ويلتزم بعدم استخدام المنصة أو ما يتوفر عليها من معلومات أو خدمات أو أدوات للقيام بأي عمل ينتج عنه مخالفة أو جريمة بموجب أي نظام ساري المفعول في المملكة العربية السعودية، وذلك بغض النظر عمن وجهت إليه تلك المخالفة أو ذلك الجرم.</span></p>



<p dir="rtl" style=""><span style="">المحتوى</span></p>

<p dir="rtl" style=""><span style="">إن اسم نافذة (شركة نافذة الرقمية لإدارة الأملاك) وشعارها وعناوينها وكل ما تتضمنه المنصة على سبيل المثال لا الحصر من مواد ونصوص وصور ورسومات وتصاميم ونماذج وملفات وسائط متعددة وبرمجيات وتبويبها هو ملك لنافذة وتحتفظ نافذة بكافة حقوق الملكية الفكرية المتعلقة بها بما في ذلك حقوق النشر والتوزيع، ولا يسمح بإعادة طبع هذه المواد، أو توزيعها، أو تعديلها، أو استخدامها لأغراض تجارية، أو دعائية، أو إعادة نشرها بأي شكل دون الحصول على إذن خطي وصريح من نافذة.</span></p>

<p dir="rtl" style=""><span style="">تحتفظ نافذة بالحق في مراقبة أي محتوى يتم إدخاله من قبل المستخدم.</span></p>

<p dir="rtl" style=""><span style="">تحتفظ نافذة بالحق (من دون التزام) في شطب أو إزالة أو تحرير أي مواد مدخلة من شأنها انتهاك هذه الشروط والأحكام.</span></p>

<p dir="rtl" style=""><span style="">تحتفظ نافذة بالحق في حذف أي معلومات تعتبرها انتهاكاً لأي من شروط وأحكام الاستخدام دون إشعار.</span></p>

<p dir="rtl" style=""><span style="">إن المحتويات والأدوات على المنصة مقدمة للمستخدمين كما هي، من دون ضمانات من أي نوع، سواء كانت صريحة أو ضمنية.</span></p>

<p dir="rtl" style=""><span style="">قد تقود بعض الروابط على البوابة إلى مواقع إلكترونية لا يتم تشغيلها من قبل المنصة، وليس للمنصة سيطرة عليها، كما أن المنصة لا تقوم بمراجعة أو التحكم بالمحتوى الخاص بتلك المواقع، وعند اختيار المستخدم لرابط خاص بموقع خارجي، فإنه يخضع للشروط والأحكام الخاصة بذلك الموقع الخارجي.</span></p>



<p dir="rtl" style=""><span style="">تنازل عن الضمان</span></p>

<p dir="rtl" style=""><span style="">تسعى نافذة إلى توفير إمكانية دخول آمن إلى المنصة وإلى الخدمات المقدمة من خلالها، لكن ونتيجة لعوامل خارجة عن سيطرة نافذة، فإن نافذة لا تضمن إمكانية الدخول المستمر بحرية ودون انقطاع وبشكل آمن إلى البوابة أو أي من خدماتها، كما لا تتحمل نافذة المسؤولية عن أي انقطاع أو تأخير أو خلل في الخدمات المقدمة عبر المنصة.</span></p>

<p dir="rtl" style=""><span style="">يقر المستخدم أن استخدامه للمنصة أو أي مادة متاحة من خلالها خاضع لمسؤولياته الخاصة، ولا توفر المنصة ولا أي من موظفيها ضمانة بأن المنصة لن تتعرض للتوقف أو أنها ستكون خالية من المشاكل أو الحذف أو الأخطاء، كما لا توجد ضمانة بشأن النتيجة التي سيحصل عليها المستخدم جراء استخدامه للمنصة أو التسجيل فيها.</span></p>

<p dir="rtl" style=""><span style="">لقد قامت نافذة باتخاذ كافة التدابير المناسبة لوضع المعلومات على المنصة وستحاول العمل على تحديث هذه المعلومات أولاً بأول، ومع هذا، فإن المنصة لا تمنح أي ضمانات صريحة أو ضمنية بخصوص دقة المعلومات المنشورة أو موافقتها لواقع الحال أو اكتمالها.</span></p>



<p dir="rtl" style=""><span style="">حدود المسؤولية</span></p>

<p dir="rtl" style=""><span style="">لا تتحمل نافذة المسؤولية عن أي خسارة في الأرباح أو أي خسارة من أي نوع نتيجة للمعلومات أو الخدمات التي تقوم بتقديمها.</span></p>

<p dir="rtl" style=""><span style="">لا تتحمل نافذة المسؤولية عن أي خسارة أو تعديل أو ضرر في بيانات المستخدمين المخزنة على المنصة، مما ينشأ عنه حصول شخص غير مفوض على حق الدخول إلى بيانات المستخدم المخزنة لدى المنصة.</span></p>
...
<p dir="rtl" style=""><span style="">يحق لنافذة تعديل هذه الشروط والأحكام أو استبدالها كليا بشروط وأحكام أخرى جديدة وإشعاركم بذلك، وتصبح التعديلات نافذة فور نشرها على المنصة ما لم يتم بيان خلاف ذلك، ويعتبر استمرارية دخول المستخدم للمنصة أو استخدامه للخدمات التي توفرها المنصة بمثابة موافقة منه على هذه التغييرات</span></p>



<p dir="rtl" style=""><span style="">حل النزاع</span></p>

<p dir="rtl" style=""><span style="">في حال نشوء أي نزاع يقع بسبب هذه البنود، أو الشروط، أو الأحكام، أو الاستخدام يتم حله وديّا وفي حال تعذّر الحل الودي ستكون المحاكم المختصة في مدينة الرياض هي جهة الاختصاص</span></p>
