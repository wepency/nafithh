...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">APP</span><span class="logo-lg">' .$logo. '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?=Yii::$app->homeUrl?>user/profile" class="btn btn-default btn-flat"><?= yii::t('app','Profile')?></a>
                            </div>
                ...
                <li>
                    <a class="nav-link active" href="<?=Yii::$app->homeUrl?>site/language?language=<?= $targt_lang ?>" class="lang-link"><?= Yii::t('app',$targt_lang_n) ?></a>
                </li>
            </ul>
        </div>
    </nav>
