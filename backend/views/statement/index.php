...
$this->title = Yii::t('app', 'Owner Statement').' :'.$owner->name;
...
<div class="statement-index ">
    <div id="ajaxCrudDatatable " class="box box-primary">
        <div class="box-body table-responsive">
            ...
            <div class='col-sm-12'>
                <?= Html::a(Yii::t('app', 'Owner Statement'), ['statement-owner','owner_id' => $owner->id,'housing_ids'=>$searchModel->housing_ids], ['class' => 'btn btn-success btn-flat bg-green-gradient','data-pjax'=>1,'role'=>'modal-remote']) ?>
            </div>
        </div>
