    ...
    <div class="box-body table-responsive">
        <fieldset>
            ...
            <div class='col-sm-12'> 
                ...
                <div class='col-sm-3'><?= $form->field($model, "room_type")->textInput() ?></div>
                ...
                <div class='col-sm-3'><?= $form->field($model, "length")->textInput(['maxlength' => true]) ?></div>
                <div class='col-sm-3'><?= $form->field($model, "width")->textInput(['maxlength' => true]) ?></div>
                <div class="clearfix"></div> 
                
                <label for='' class='col-sm-2 control-label'><?=Yii::t('app', 'Title Ads')?> <span class="clsReq">*</span></label>
                <div class='col-sm-4'>
                    <?= $form->field($model, 'ad_description')->textInput(['placeholder'=>Yii::t('app', 'Example: a two-story apartment in Al-Falah neighborhood')])->label(false) ?>
                </div> 
                <div class="clearfix"></div> 
                ...
                <div class='col-sm-4'><?= $form->field($model, "ad_subtype")->radioList(Yii::$app->params['adsubtype'][Yii::$app->language])->label(false) ?></div>
                <div class="clearfix"></div> 
