    ...
    <div class="box-body table-responsive">
        <fieldset>
            ...
            <div class='col-sm-12'>
                ...
                <!--                <div class='col-sm-3'>-->
                <?php //= $form->field($model, "room_type")->textInput() ?><!--</div>-->
                ...
                <!--                 <label for='' class='col-sm-12 control-label' style="font-weight:bold !important;" >-->
                <?php //= Yii::t('app', 'Limits and Lengths of the Property') ?><!-- </label>-->
                <!--                <div class='col-sm-3'>-->
                <?php //= $form->field($model, "length")->textInput(['maxlength' => true]) ?><!--</div>-->
                <!--                <div class='col-sm-3'>-->
                <?php //= $form->field($model, "width")->textInput(['maxlength' => true]) ?><!--</div>-->
                <!--                <div class="clearfix"></div> -->
                ...
                <!--                <div class='col-sm-4'>-->
                <?php //= $form->field($model, "ad_subtype")->radioList(Yii::$app->params['adsubtype'][Yii::$app->language])->label(false) ?><!--</div>-->
                <div class="clearfix"></div>
