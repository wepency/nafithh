...
/**
 * SystemIncomeSearch represents the model behind the search form of `common\models\SystemIncome`.
 */
class SystemIncomeSearch extends SystemIncome
{
    use FilterDate;
    /**
     * {@inheritdoc}
