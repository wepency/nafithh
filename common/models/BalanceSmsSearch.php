...
/**
 * BalanceSmsSearch represents the model behind the search form of `common\models\BalanceSms`.
 */
class BalanceSmsSearch extends BalanceSms
{
    use FilterDate;
    /**
     * @inheritdoc
