...
// for validate by custom field in object 
 // [['list_setting'],'each', 'rule' => ['required'] , 'when' => function($model) {
 //                return $model->list_setting['city'] == null ;
 //            }, 'whenClient' => "function (attribute, value) {
 //                return jQuery.isEmptyObject($('#institute-list_setting-city').val()) ;
 //            }", 'message' => yii::t('app','You must enter a Grops or Emails')],

// for validate for all fields in object 
 // [['list_setting'],'each', 'rule' => ['required']],
