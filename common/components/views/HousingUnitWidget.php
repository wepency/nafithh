                        ...
                        <div class="row">
                            <fieldset>
    							<div class='col-sm-12'>	
                                    ...
                                    <div class='col-sm-3'><?= $form->field($modelHousing, "[{$i}]room_type")->textInput() ?></div>
                                    ...
                                    <div class='col-sm-3'><?= $form->field($modelHousing, "[{$i}]ad_subtype")->radioList(Yii::$app->params['adsubtype'][Yii::$app->language])->label(Yii::t('app', 'Ad Sub Type')) ?></div>
                                    <div class="clearfix"></div>        
                                    ...
                                    <div class='col-sm-3'><?= $form->field($modelHousing, "[{$i}]length")->textInput(['maxlength' => true]) ?></div>
                                    <div class='col-sm-3'><?= $form->field($modelHousing, "[{$i}]width")->textInput(['maxlength' => true]) ?></div>
                                    <div class="clearfix"></div> 
                                    <div class='col-sm-6'>
                                        <?= $form->field($modelHousing, "[{$i}]ad_description")->textInput(['placeholder'=>Yii::t('app', 'Example: a two-story apartment in Al-Falah neighborhood')]) ?>
                                    </div>
                                    <div class="clearfix"></div> 
                                    <div class='col-sm-6'>
                                        <?= $form->field($modelHousing, "[{$i}]ad_publish_date")->widget(DatePicker::class,[
                                    ...
                                    <div class='col-sm-6'>
                                        <?= $form->field($modelHousing, "[{$i}]ad_expire_date")->widget(DatePicker::class,[
                                            'type' => DatePicker::TYPE_INPUT,
                                            'value' => '23-Feb-1982',
                                            'pluginOptions' => [
                                                'autoclose'=>true,
                                    ...
                                    <div class='col-sm-6'>
                                        <?= $form->field($modelHousing, "[{$i}]ad_status")->radioList(Yii::$app->params['statusCase'][Yii::$app->language]) ?>
