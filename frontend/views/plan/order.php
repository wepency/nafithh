                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="" class="form-control" disabled="" value="<?=$model->plan->_title?? '' ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label><?= yii::t('app','Plan Price') ?></label>
                                                <input type="text" name="" class="form-control" disabled="" value="<?=$model->plan->price?? '' ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                             <div class="form-group">
                                                <label><?= yii::t('app','Account Number') ?></label>
                                                <input type="text" name="" class="form-control" disabled="" value="<?=$siteSetting->account_number ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label><?= yii::t('app','Iban Number') ?></label>
                                                <input type="text" name="" class="form-control" disabled="" value="<?=$siteSetting->iban_number ?>">
                                            </div>
                                        </div>
                                         <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label><?= yii::t('app','Bank Name') ?></label>
                                                <input type="text" name="" class="form-control" disabled="" value="<?=$siteSetting->bank_name ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
