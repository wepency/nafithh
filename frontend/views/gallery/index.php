    ...
    <section class="gallary-sec">
                        ...
                        */ ?>
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?=(!($adSubType == 2 || $adSubType == 0))? 'active' :''?>" id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" value='1' aria-controls="pills-home" aria-selected="true"><?=Yii::$app->params['adsubtype'][Yii::$app->language][1]?></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?=($adSubType == 0) ? 'active' :''?>" id="pills-profile-tab" data-toggle="pill" data-target="#pills-profile" type="button" role="tab" value='0' aria-controls="pills-profile" aria-selected="false"><?=Yii::$app->params['adsubtype'][Yii::$app->language][0]?></button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?=($adSubType == 2) ? 'active' :''?>" id="pills-contact-tab" data-toggle="pill" data-target="#pills-contact" type="button" role="tab" value='2' aria-controls="pills-contact" aria-selected="false"><?=Yii::$app->params['adsubtype'][Yii::$app->language][2]?></button>
                            </li>
                        </ul>
                                ...
                                <div class="search-frm">
                                    <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        <?=Select2::widget([
                                                            ...
                                                            'class'=>'form-control estate_filter',
                                                            'data' =>ArrayHelper::map(BuildingType::find()->where(['>','id',0])->all(),'id','_name'),
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                                    ...
                                                    <div class="mobile-show">
                                                        <div class="form-group">
                                                            <button class="form-control"  id="showPriceControlsMobile">
                                                                <?= yii::t('app','Price') ?>
                                                            </button>
                                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-3 col-sm-12 col-12 d-flex justify-content-center align-self-center">
                                            <button type="button" id="search" class="btn btn-light custom-btn"><?= yii::t('app','Search') ?></button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex align-self-center">
                            <p class="mb-0">
                               <?= yii::t('app','Found') ?> <span class="search-no">0 </span><?= yii::t('app','Estates') ?>
                            </p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 d-flex justify-content-end align-self-center center-align">
                            ...
                            <div class="grid-icon mx-2 <?=($styleView !== 'list') ? 'active-list' :''?>" id="show-grid">
                                <img src="<?=Yii::$app->homeUrl?>images/visualization.png" class="gray-ico">
                                <img src="<?=Yii::$app->homeUrl?>images/visualization-active.png" class="active-ico">
                            </div>
                            <div class="list-icon <?=($styleView == 'list') ? 'active-list' :''?> " >
                                <img src="<?=Yii::$app->homeUrl?>images/list-text.png" class="gray-ico" id="show-list">
        ...
        <div class="container " >
            ...
            <div class="gallary-div pt-50 loader" id="pjax_result">
                <?= $this->render('_list',['gallery'=>$gallery, 'pages' => $pages]);?>
            </div>
