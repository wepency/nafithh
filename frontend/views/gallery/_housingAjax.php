			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-12">
				<div class="gallary-block">
					<div class="gallary-img">
						<a href="<?=Yii::$app->homeURL?>gallery/housing/<?=$row->id?>">
						<?php 
					...
					<div class="gallary-disc">
						<a href="<?=Yii::$app->homeURL?>gallery/housing/<?=$row->id?>">
							<h5><?= $row->housing_unit_name ?></h5>
						</a>
						<p>
							<a href="https://maps.google.com/maps?q=<?= $row->building->lat ?>,<?= $row->building->lang ?>" target="_blank">	<i class="fas fa-map-marker-alt"></i> </a>
							<span><?= $row->building->city->_name?? '' ?> - <?= $row->building->district->_name?? '' ?> </span>
						</p>
					</div>
