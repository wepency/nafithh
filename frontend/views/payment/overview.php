                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-5">
                        <div class="price-block">
                            ...
                            <div class="package-price"
                                ...
                                <p class="mb-0"><span
                                            class="price"><?= GeneralHelpers::currency($model->price + (float)GeneralHelpers::taxes($model->price)) ?></span>
                                </p>
                            ...
                            <?php $form = ActiveForm::begin(['action' => Yii::$app->BaseUrl->baseUrl . '/payment/do-pay', 'method' => 'post']); ?>
                            ...
                            <div class="coupon-wrap">
                                <div class="form-group">
                                    ...
                                    <div class="field">
                                        <input class="form-control coupon-field" name="couponCode" id="coupon-check"
                                               type="text"/>
                                        <button id="validate-coupon" class="btn btn-dark"><i class="fa fa-recycle"></i>
                                            تفعيل
                                        </button>
                                    </div>
...
<script>
    $('#validate-coupon').click(function (e) {
        ...
        $.ajax({
            url: '<?= Yii::$app->homeUrl . "payment/check-coupon"?>',
            type: 'post',
